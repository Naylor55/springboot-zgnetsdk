package com.ramble.springbootzgnetsdk.handler.exception;

import com.ramble.springbootzgnetsdk.handler.GlobalResponseEntity;
...
@RestControllerAdvice(basePackages = {"com.ramble"})
@ResponseBody
@Slf4j
public class GlobalException {
    ...
    public ResponseEntity<Object> handleRuntimeException(RuntimeException e) {
        ...
        return new ResponseEntity<>(
                new GlobalResponseEntity(false, "55555",
